...
func _() {
	...
	var x [1]struct{}
	_ = x[DwarfTagNull-0]
	_ = x[DwarfTagArrayType-1]
	_ = x[DwarfTagClassType-2]
	_ = x[DwarfTagEntryPoint-3]
	_ = x[DwarfTagEnumerationType-4]
	_ = x[DwarfTagFormalParameter-5]
	_ = x[DwarfTagImportedDeclaration-8]
	_ = x[DwarfTagLabel-10]
	_ = x[DwarfTagLexicalBlock-11]
	_ = x[DwarfTagMember-13]
	_ = x[DwarfTagPointerType-15]
	_ = x[DwarfTagReferenceType-16]
	_ = x[DwarfTagCompileUnit-17]
	_ = x[DwarfTagStringType-18]
	_ = x[DwarfTagStructureType-19]
	_ = x[DwarfTagSubroutineType-21]
	_ = x[DwarfTagTypedef-22]
	_ = x[DwarfTagUnionType-23]
	_ = x[DwarfTagUnspecifiedParameters-24]
	_ = x[DwarfTagVariant-25]
	_ = x[DwarfTagCommonBlock-26]
	_ = x[DwarfTagCommonInclusion-27]
	_ = x[DwarfTagInheritance-28]
	_ = x[DwarfTagInlinedSubroutine-29]
	_ = x[DwarfTagModule-30]
	_ = x[DwarfTagPtrToMemberType-31]
	_ = x[DwarfTagSetType-32]
	_ = x[DwarfTagSubrangeType-33]
	_ = x[DwarfTagWithStmt-34]
	_ = x[DwarfTagAccessDeclaration-35]
	_ = x[DwarfTagBaseType-36]
	_ = x[DwarfTagCatchBlock-37]
	_ = x[DwarfTagConstType-38]
	_ = x[DwarfTagConstant-39]
	_ = x[DwarfTagEnumerator-40]
	_ = x[DwarfTagFileType-41]
	_ = x[DwarfTagFriend-42]
	_ = x[DwarfTagNamelist-43]
	_ = x[DwarfTagNamelistItem-44]
	_ = x[DwarfTagPackedType-45]
	_ = x[DwarfTagSubprogram-46]
	_ = x[DwarfTagTemplateTypeParameter-47]
	_ = x[DwarfTagTemplateValueParameter-48]
	_ = x[DwarfTagThrownType-49]
	_ = x[DwarfTagTryBlock-50]
	_ = x[DwarfTagVariantPart-51]
	_ = x[DwarfTagVariable-52]
	_ = x[DwarfTagVolatileType-53]
	_ = x[DwarfTagDwarfProcedure-54]
	_ = x[DwarfTagRestrictType-55]
	_ = x[DwarfTagInterfaceType-56]
	_ = x[DwarfTagNamespace-57]
	_ = x[DwarfTagImportedModule-58]
	_ = x[DwarfTagUnspecifiedType-59]
	_ = x[DwarfTagPartialUnit-60]
	_ = x[DwarfTagImportedUnit-61]
	_ = x[DwarfTagCondition-63]
	_ = x[DwarfTagSharedType-64]
	_ = x[DwarfTagTypeUnit-65]
	_ = x[DwarfTagRvalueReferenceType-66]
	_ = x[DwarfTagTemplateAlias-67]
	_ = x[DwarfTagCoarrayType-68]
	_ = x[DwarfTagGenericSubrange-69]
	_ = x[DwarfTagDynamicType-70]
	_ = x[DwarfTagAtomicType-71]
	_ = x[DwarfTagCallSite-72]
	_ = x[DwarfTagCallSiteParameter-73]
	_ = x[DwarfTagSkeletonUnit-74]
	_ = x[DwarfTagImmutableType-75]
	_ = x[DwarfTagMIPSLoop-16513]
	_ = x[DwarfTagFormatLabel-16641]
	_ = x[DwarfTagFunctionTemplate-16642]
	_ = x[DwarfTagClassTemplate-16643]
	_ = x[DwarfTagGNUTemplateTemplateParam-16646]
	_ = x[DwarfTagGNUTemplateParameterPack-16647]
	_ = x[DwarfTagGNUFormalParameterPack-16648]
	_ = x[DwarfTagGNUCallSite-16649]
	_ = x[DwarfTagGNUCallSiteParameter-16650]
	_ = x[DwarfTagAPPLEProperty-16896]
	_ = x[DwarfTagBORLANDProperty-45056]
	_ = x[DwarfTagBORLANDDelphiString-45057]
	_ = x[DwarfTagBORLANDDelphiDynamicArray-45058]
	_ = x[DwarfTagBORLANDDelphiSet-45059]
	_ = x[DwarfTagBORLANDDelphiVariant-45060]
}
